    ...
    <div className="flex flex-wrap items-center justify-center gap-4 mt-4">
      ...
      {criticalCans > 0 && (
        <div className="bg-[#1a1a3e] border-2 border-[#ff4466] px-4 py-2 animate-pulse">
          <span className="text-[#ff4466] tracking-wider" style={{ fontFamily: 'monospace' }}>
      ...
      {warningCans > 0 && (
        <div className="bg-[#1a1a3e] border-2 border-[#ffaa44] px-4 py-2">
          <span className="text-[#ffaa44] tracking-wider" style={{ fontFamily: 'monospace' }}>
            WARNING: {warningCans}
          </span>
        </div>
      )}
      ...
      <div className="bg-[#1a1a3e] border-2 border-[#50d070]/50 px-4 py-2">
        <span className="text-[#50d070]/80 tracking-wider" style={{ fontFamily: 'monospace' }}>
